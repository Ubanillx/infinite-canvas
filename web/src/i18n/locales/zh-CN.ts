export default {
    ...
    config: {
        ...
        fileSecurity: "服务器托管的 API Key 与 WebDAV 连接信息不会写入导出的 JSON 文件。",
        import: "导入配置",
        export: "导出配置",
        imported: "配置与用户偏好已导入",
        ...
        webdav: {
            title: "WebDAV 同步",
            description: "自动同步配置、画布、我的资产、生成记录和本地媒体文件。",
            ...
            autoSync: "自动同步",
            autoSyncDescription: "配置修改约 1 秒后同步，画布和资产修改约 10 秒后同步，并按所选周期同步全部数据。",
