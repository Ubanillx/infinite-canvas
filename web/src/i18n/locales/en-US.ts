export default {
    ...
    config: {
        ...
        fileSecurity: "Server-managed API keys and WebDAV connection details are not included in exported JSON files.",
        ...
        webdav: {
            title: "WebDAV sync",
            description: "Automatically sync settings, canvases, assets, generation history, and local media files.",
            ...
            autoSyncDescription: "Settings sync about 1 second after changes, canvases and assets after about 10 seconds, with a full sync on the selected schedule.",
