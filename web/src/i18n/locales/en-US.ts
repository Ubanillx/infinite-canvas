export default {
    ...
    config: {
        ...
        serverStorage: {
            ...
            loadFailed: "Unable to load server settings",
            saveFailed: "Failed to save server settings",
            invalidResponse: "The server returned invalid settings",
            requestFailed: "Settings server request failed ({{status}})",
            upload: "Upload to server",
            uploaded: "Settings uploaded to server",
        },
        tabs: {
            channels: "Providers",
        ...
        fileSecurity: "Settings are loaded from the server and kept in this session's memory; click “Upload to server” to share changes. Server-managed API keys and WebDAV connection details are not included in exported JSON files.",
        import: "Import settings",
        export: "Export settings",
        imported: "Settings and preferences imported for this session (not uploaded)",
        importedDirectConfig: "Local direct connection settings imported",
        importFailed: "Failed to read the settings file",
        saved: "Settings applied for this session (not uploaded)",
        savedContinue: "Settings applied for this session (not uploaded). Continue with your previous request.",
        channels: {
        ...
        channelEditor: {
            ...
            apiKeyWriteOnly: "The key can only be replaced and is never shown again after saving.",
        ...
        webdav: {
            title: "WebDAV sync",
            description: "Settings are loaded from the server; click “Sync now” to manually sync workspace data.",
            serverManagedTitle: "Server-managed connection",
            serverManagedDescription: "The WebDAV address, directory, and credentials are stored on the server. The browser never reads or displays them.",
            lastSynced: "Last synced {{time}}",
            configLastSynced: "Settings synced {{time}}",
            ...
            passwordConfigured: "Configured; enter a new password to replace it",
            passwordPlaceholder: "Enter password / app password",
            passwordWriteOnly: "The password can only be replaced and is never shown again after saving.",
            autoSync: "Automatic sync (disabled)",
            autoSyncDescription: "All users use manual synchronization; settings are written to the server only after clicking “Upload to server”.",
            autoSyncInterval: "Full sync interval",
            intervalMinutes: "Every {{count}} minutes",
            sensitiveConfigTitle: "Remote settings contain secrets",
            sensitiveConfigDescription: "WebDAV config.json contains AI API keys and WebDAV credentials. Restrict the remote directory to trusted accounts.",
            autoSyncFailed: "Automatic sync failed",
            autoSyncing: "Automatic sync in progress",
