export default {
    ...
    config: {
        ...
        webdav: {
            title: "WebDAV sync",
            description: "Automatically sync settings, canvases, assets, generation history, and local media files. The configured Synology target uses a same-origin proxy, while other addresses connect directly.",
